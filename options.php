...
function optionsframework_options() {
    ...
    $options[] = array(
        'name' => __( '浏览器颜色', 'theme-textdomain' ),
        'desc' => __( '详见：<a href="https://developers.google.cn/web/fundamentals/design-and-ux/browser-customization/?hl=zh-cn#_2">定义浏览器元素的颜色</a>。请输入 RGB 值，不要留空，留空时将显示浏览器默认颜色。<b>默认为 #e0e0e0</b>', 'theme-textdomain' ),
        'id' => 'tm_status_color',
        'std' => '#e0e0e0',
        'class' => 'mini',
        'type' => 'text'
	...
	$options[] = array(
		...
		'desc' => __('此处内容<b>没有被</b>&lt;script&gt;围起来，请<b>带着标签</b>输入脚本内容，此处也可当自定义HTML代码使用（代码从页底插入）', 'theme-textdomain'),
		'id' => 'diy_js',
		'type' => 'textarea'
	);
	...
	$options[] = array(
		...
		'desc' => __( '在此填入博客建立的年份，请别留空，<b>默认为 2012</b>', 'theme-textdomain' ),
		'id' => 'found_year',
		'std' => '2012',
		'type' => 'text'
	);
